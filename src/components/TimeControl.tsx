...
export default function TimeControl(props: TimeControlProps) {
  ...
  return (
    <div class="fixed top-4 left-4 z-50 w-44">
      <div class="bg-linear-to-b from-stone-800/95 to-stone-900/95 border-2 border-amber-700/50 backdrop-blur-sm shadow-xl">
        ...
        <div class="p-3 space-y-2">
          ...
          <button
            ...
            class={`w-full px-4 py-2 font-serif text-sm tracking-wide border transition-all whitespace-nowrap ${
              props.isRunning()
          ...
          <button
            onClick={props.reset}
            class="w-full px-4 py-2 bg-linear-to-b from-stone-700 to-stone-800 border border-stone-600 text-stone-300 font-serif text-sm tracking-wide hover:from-stone-600 hover:to-stone-700 transition-all"
          >
            ↺ Restart
          </button>
        </div>
